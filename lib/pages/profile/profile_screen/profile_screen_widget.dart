                              ...
                              onTap: () async {
                                ...
                                var confirmDialogResponse = await showDialog<
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title:
                                              const Text('Sua imagem será alterada'),
                                          content: const Text(
                                              'Deseja realmente alterar a imagem?'),
                                          actions: [
                                            TextButton(
                                ...
                                if (confirmDialogResponse) {
                                  setState(() {
                                    _model.userProfileImg =
                                        _model.uploadedFileUrl;
                                  });

                                  await currentUserReference!
                                      .update(createUsuarioRecordData(
                                    photoUrl: _model.userProfileImg,
                                  ));
                                  return;
                                } else {
                                  return;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('SupportScreen');
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('VendorDataScreen');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('UserDataScreen');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment: MainAxisAlignment.start,
